...
U2_RX_CB U2_RX_Struct;
uint8_t U1_RX_Buffer[RX_BUFFER_SIZE];
uint8_t U2_TX_Buffer[100];
uint8_t U2_RX_Buffer[RX_BUFFER_SIZE];
...
void U1_CB_Init()
{
    ...
    U1_RX_Struct.RX_In->end = U1_RX_Buffer;
}

void U2_CB_Init()
{
    U2_RX_Struct.RX_Counter = 0;
    U2_RX_Struct.RX_In = U2_RX_Struct.SE_Buffer;
    U2_RX_Struct.RX_Out = U2_RX_Struct.SE_Buffer;
    U2_RX_Struct.RX_End = &U2_RX_Struct.SE_Buffer[9];
    U2_RX_Struct.RX_In->start = U2_RX_Buffer;
    U2_RX_Struct.RX_In->end = U2_RX_Buffer;
}
/* USER CODE END 1 */
