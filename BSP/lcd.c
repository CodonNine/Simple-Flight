...
void LCD_Show_UI()
{
//    LCD_ShowString(0,0,"Channel1:",BLACK,WHITE,24,0);
//    LCD_ShowString(0,24,"Channel2:",BLACK,WHITE,24,0);
//    LCD_ShowString(0,48,"Channel3:",BLACK,WHITE,24,0);

    LCD_DrawRectangle(20,20,30,135-20,BLACK);
    LCD_DrawRectangle(180,48,220,88,BLACK);
    //LCD_Draw_Block(200,68,RED);
}

void LCD_Draw_Block(uint16_t x,uint16_t y,uint16_t color)
{
...
void LCD_Update()
{
    static char ch1[10],ch2[10],ch3[10];
    sprintf(ch1,"%d",ADC_Value[0]);
    sprintf(ch2,"%d",ADC_Value[1]);
    sprintf(ch3,"%d",ADC_Value[2]);
    LCD_ShowString(110,0,(uint8_t*)ch1,BLACK,WHITE,24,0);
    LCD_ShowString(110,24,(uint8_t*)ch2,BLACK,WHITE,24,0);
    LCD_ShowString(110,48,(uint8_t*)ch3,BLACK,WHITE,24,0);
}